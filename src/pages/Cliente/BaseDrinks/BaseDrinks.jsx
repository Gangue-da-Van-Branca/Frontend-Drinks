...
function BaseDrinks(){
    ...
    return (
        <div id="pagina-base-festa">
            <h1 id="titulo">Base da Festa</h1>
            <hr id="linha-titulo"/>
            <p id="descricao"> kndanldnalnsk dladmlakd dalmdmlandsmdna diahd</p>
            ...
            <button id="botao-avancar" onClick={handleAvancar}>Avançar</button>
        </div>
    )
}
